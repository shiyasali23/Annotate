    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='food_scores', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='foodsscore',
            index=models.Index(fields=['user'], name='webapp_food_user_id_df4b35_idx'),
        ),
    ]
