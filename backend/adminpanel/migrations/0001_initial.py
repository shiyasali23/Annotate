    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('food', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='image', to='adminpanel.food')),
            ],
        ),
        migrations.AddField(
            model_name='food',
        ...
        migrations.AddField(
            ...
            name='biochemical',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conditions', to='adminpanel.biochemical'),
        ),
        migrations.AddField(
            model_name='biochemicalcondition',
            name='condition',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adminpanel.condition'),
        ),
        migrations.AddField(
            model_name='biochemical',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='biochemicals', to='adminpanel.category'),
        ),
        migrations.AddIndex(
