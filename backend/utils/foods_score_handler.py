...
class FoodScoreHandler:
    ...
    def create_foods_score(self, biochemicals_scaled_values, user):
        try:
            self.user = user
    ...
    def handle_create_foods_score(self, biochemicals_scaled_values, user):
        try:
            return self._calculate_food_scores(
            ...
            return response_handler.handle_exception(
                exception=f"Error handling create foods score: {str(e)}"
            )
